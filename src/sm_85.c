...
static const uint16 kTileNumbersForButtonLetters[8] = { 0xe, 0xe, 0xe, 0xe, 0xe, 0xe, 0xe, 0xe };
...
static void DrawShootButtonAndSetupPpuForLargeMessageBox(void) {  // 0x8583C5
  DrawSpecialButtonAndSetupPpuForLargeMessageBox(button_config_shoot_y);
}

static void DrawRunButtonAndSetupPpuForLargeMessageBox(void) {  // 0x8583CC
  DrawSpecialButtonAndSetupPpuForLargeMessageBox(button_config_run_a);
}
...
static const uint16 kSaveConfirmationSelectionTilemap[96] = {  // 0x858507
     0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe, 0x38bc, 0x38bd, 0x3cd8, 0x3cc4, 0x3cd2,    0xe,    0xe,    0xe,
     0xe,    0xe,    0xe, 0x2ccd, 0x2cce,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,
     0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe, 0x38bc, 0x38bd, 0x3cd8, 0x3cc4, 0x3cd2,    0xe,    0xe,    0xe,
     0xe,    0xe,    0xe, 0x2ccd, 0x2cce,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,
     0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe, 0x2cd8, 0x2cc4, 0x2cd2,    0xe,    0xe,    0xe,
     0xe, 0x38bc, 0x38bd, 0x3ccd, 0x3cce,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,    0xe,
};
